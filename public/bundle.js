...
/***/ (function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var NavComponent = __webpack_require__(217);
	...
	var Weather = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(WeatherForm, { onNewName: this.handleSearch }),
	      renderMessage()
	    );
	  }
	});
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { type: 'text', placeholder: 'Enter city name', ref: 'cityname' }),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=70f8ff43b820e01d42ce17999395f0a1&units=imperial';
